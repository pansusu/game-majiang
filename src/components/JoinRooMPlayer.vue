...
import type OtherPlayer from "@/server/vo/OtherPlayer.js";
...
<template>
	<div class="flex items-center justify-center bg-gray-50 shadow py-7 mb-6">
		<n-space>
			<div class="text-center" v-for="p,index in players">
